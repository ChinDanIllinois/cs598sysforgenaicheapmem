...
# ============ Small Model Paths ============
LLMLINGUA_MODEL_PATH="/Users/chinmaydandekar/Desktop/'/CS\ 598\ -\ Systems\ for\ GenAI/lightmem-playground/llmlingua-2-bert-base-multilingual-cased-meetingbank"
EMBEDDING_MODEL_PATH="/Users/chinmaydandekar/Desktop/'/CS\ 598\ -\ Systems\ for\ GenAI/lightmem-playground/all-MiniLM-L6-v2"

# ============ Data Configuration ============
DATA_PATH="/Users/chinmaydandekar/Desktop/'/CS\ 598\ -\ Systems\ for\ GenAI/lightmem-playground/longmemeval-cleaned/longmemeval_s_cleaned.json"
RESULTS_DIR='../results'
...
def load_lightmem(collection_name):
    ...
    "text_summary": True,
    "memory_manager": {
        "model_name": 'gemini', # such as 'openai' or 'ollama' ...
        "configs": {
            "model": LLM_MODEL,
            "api_key": API_KEY,
            "max_tokens": 16000,
